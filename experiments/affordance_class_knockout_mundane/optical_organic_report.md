...
base=canonical_hard_gate | ablation=knockout_optical_organic | base_docs=13 | ablation_docs=6
...
| selector_alpha_0 | animating_mediator | 14.3% | 20.0% | +5.7% |
| selector_alpha_0 | text_memory | 57.1% | 60.0% | +2.9% |
| selector_alpha_0 | threshold_container | 42.9% | 40.0% | -2.9% |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| selector_alpha_0 | 0.71 | +0.003 | -0.025 | 0.0% | 0.000 | +0.039 | -0.23 | 100.0% |
| steer_alpha_0p77 | 0.33 | +0.064 | -0.385 | 0.0% | 0.000 | -0.946 | -0.33 | 100.0% |
| steer_alpha_0p82 | 0.00 | -0.150 | +1.000 | 0.0% | 0.000 | -0.959 | -2.00 | 0.0% |
...
- knockout_optical_organic selector_alpha_0__reselect_banded-frontier_best: docs=5 frontier=0.135 unfinished=0.000 load=1.20 entropy=0.921 compliance=100.0% | text_memory=60.0%, threshold_container=40.0%, animating_mediator=20.0%
- knockout_optical_organic steer_alpha_0p77__reselect_banded-frontier_best: docs=1 frontier=0.230 unfinished=0.000 load=1.00 entropy=0.000 compliance=100.0% | text_memory=100.0%
